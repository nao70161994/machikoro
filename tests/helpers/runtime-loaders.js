...
function loadGameRuntime() {
    ...
    loadScripts(context, ['js/Card.js', 'js/Player.js', 'js/actionContract.js', 'js/GameManager.js']);
    vm.runInContext(
...
function loadCPURuntime() {
    const context = { console, Math: Object.create(Math) };
    vm.createContext(context);
    loadScripts(context, ['js/Card.js', 'js/Player.js', 'js/actionContract.js', 'js/GameManager.js', 'js/cpuTuning.js', 'js/cpuProfile.js', 'js/cpuDiagnostics.js', 'js/cpuEvaluationCache.js', 'js/cpuEvaluation.js', 'js/cpuLegalMoves.js', 'js/cpuBuildExecution.js', 'js/cpuSimulation.js', 'js/cpuPendingResolution.js', 'js/CPU.js']);
    vm.runInContext(
