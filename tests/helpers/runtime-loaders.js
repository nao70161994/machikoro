...
function loadGameRuntime() {
    ...
    loadScripts(context, ['js/Card.js', 'js/Player.js', 'js/actionContract.js', 'js/pendingActionQueue.js', 'js/gameTurnPolicy.js', 'js/gameDicePolicy.js', 'js/gameCardActivationPolicy.js', 'js/gameBuildPolicy.js', 'js/gameCoinTransaction.js', 'js/gamePendingResolutionPolicy.js', 'js/GameManager.js']);
    vm.runInContext(
