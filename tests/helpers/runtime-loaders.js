...
function loadCPURuntime() {
    const context = { console, Math: Object.create(Math) };
    vm.createContext(context);
    loadScripts(context, ['js/Card.js', 'js/Player.js', 'js/GameManager.js', 'js/cpuTuning.js', 'js/cpuProfile.js', 'js/cpuDiagnostics.js', 'js/cpuEvaluationCache.js', 'js/cpuEvaluation.js', 'js/cpuSimulation.js', 'js/cpuPendingResolution.js', 'js/CPU.js']);
    vm.runInContext(
