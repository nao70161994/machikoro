...
const TEST_GROUPS = {
    ...
    'main.test.js',
        ...
        'report-rl-model-cards.test.js',
        'report-rl-compression.test.js',
        'plan-rl-strategy-runs.test.js',
        'rl-run-background.test.js',
        'import-rl-match-fixture.test.js',
        'review-rl-multiplayer-topk.test.js',
        'review-rl-candidate-screen.test.js',
        'review-rl-candidate-promotion.test.js',
        'rl-candidate-eval-shell.test.js',
        ...
        'eval-rl-head-to-head.test.js',
        'rl-statistics.test.js',
