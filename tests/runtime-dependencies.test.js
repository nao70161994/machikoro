...
runTest('productionと主要runtimeは抽出moduleをconsumerより先に読み込む', () => {
    const cases = [
        ['index.html', [
            ...
            ['js/onlineSocketConnect.js', 'js/onlineSocketRegistry.js', 'js/onlineInboundActionRuntime.js', 'js/onlineGameInitializer.js', 'js/onlineLobbyStartRuntime.js', 'js/online.js'],
