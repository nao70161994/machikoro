...
runTest('productionと主要runtimeは抽出moduleをconsumerより先に読み込む', () => {
    const cases = [
        ['index.html', [
            ...
            ['js/onlineRejoinPersistence.js', 'js/onlineRejoinPreparationRuntime.js', 'js/online.js'],
            ['js/onlinePendingOutboundState.js', 'js/onlinePendingResend.js', 'js/online.js'],
            ['js/onlineRestoreReplay.js', 'js/online.js'],
            ['js/onlineRestoreActivation.js', 'js/onlineRejoinActivationRuntime.js', 'js/online.js'],
