...
runTest('productionと主要runtimeは抽出moduleをconsumerより先に読み込む', () => {
    const cases = [
        ['index.html', [
            ...
            ['js/cpuBusinessDecisionRuntime.js', 'js/CPU.js'],
            ['js/cpuActionProposal.js', 'js/cpuBuildExecution.js'],
            ['js/cpuBuildExecution.js', 'js/cpuBuildProposalCollector.js'],
            ['js/cpuBuildProposalCollector.js', 'js/cpuBuildStrategy.js'],
            ...
            ['js/cpuCardEvaluationRuntime.js', 'js/CPU.js'],
            ['js/cpuStateEvaluationRuntime.js', 'js/CPU.js'],
            ['js/cpuBuildPolicyRuntime.js', 'js/CPU.js'],
            ['js/cpuSimulation.js', 'js/CPU.js'],
            ['js/cpuLookaheadRuntime.js', 'js/CPU.js'],
            ['js/cpuEvaluation.js', 'js/CPU.js'],
            ['js/cpuRollDecision.js', 'js/CPU.js'],
            ['js/cpuPendingDecision.js', 'js/CPU.js'],
            ...
            ['js/gameEngineRuntimeAdapter.js', 'js/onlineGameEngineRuntime.js', 'js/online.js'],
            ...
            ['js/gameEngineClientShadow.js', 'js/onlineGameEngineRuntime.js', 'js/online.js'],
            ...
            ['js/onlineSocketConnect.js', 'js/onlineSocketRegistry.js', 'js/onlineInboundActionRuntime.js', 'js/onlineLobbyRequestRuntime.js', 'js/onlineGameInitializer.js', 'js/onlineLobbyStartRuntime.js', 'js/online.js'],
            ['js/onlineSocketDisconnect.js', 'js/online.js'],
            ['js/onlineHostChanged.js', 'js/online.js'],
            ['js/onlineRejoinPersistence.js', 'js/onlineRejoinPreparationRuntime.js', 'js/onlineRejoinRuntime.js', 'js/online.js'],
            ['js/onlinePendingOutboundState.js', 'js/onlinePendingResend.js', 'js/online.js'],
            ['js/onlineRestoreReplay.js', 'js/online.js'],
            ['js/onlineRestoreActivation.js', 'js/onlineRejoinActivationRuntime.js', 'js/onlineRejoinRuntime.js', 'js/online.js'],
            ...
            ['js/uiPlayerCount.js', 'js/online.js'],
            ['js/uiPlayerCount.js', 'js/storage.js'],
            ['js/uiPlayerCount.js', 'js/main.js'],
            ...
            ['js/uiCardSelectEffects.js', 'js/ui.js'],
            ...
            ['js/uiModalClose.js', 'js/uiModalDomEffects.js', 'js/uiModalRuntime.js', 'js/ui.js'],
            ...
            ['js/appDiagnostics.js', 'js/main.js'],
            ['js/appBackup.js', 'js/main.js'],
            ['js/gameSetupPresets.js', 'js/main.js'],
            ['js/roomQrCode.js', 'js/online.js'],
            ['js/undoPreview.js', 'js/storage.js'],
            ['js/uiTurnPrivacy.js', 'js/ui.js'],
            ...
            ['js/retryTimer.js', 'js/appShell.js'],
            ...
            ['js/appShellComposition.js', 'js/appShell.js'],
            ['js/appShellRuntimeEffects.js', 'js/appShell.js'],
            ['js/uiWatchdogAsyncRecovery.js', 'js/appShell.js'],
            ['js/uiWatchdogRecoveryRuntime.js', 'js/appShell.js'],
            ['js/appShellUiLockRuntime.js', 'js/appShell.js'],
            ['js/appShellObservationRuntime.js', 'js/appShell.js'],
            ['js/uiWatchdogMonitor.js', 'js/appShell.js'],
            ['js/uiWatchdogReporting.js', 'js/appShell.js'],
            ['js/uiWatchdogRuntime.js', 'js/appShell.js'],
            ['js/clientRuntimeSnapshot.js', 'js/appShell.js'],
            ['js/crashScreen.js', 'js/appShell.js'],
            ['js/crashScreenEffects.js', 'js/appShell.js'],
            ['js/appShellCrashRuntime.js', 'js/appShell.js'],
            ['js/pwaShell.js', 'js/appShell.js'],
            ['js/appShellStartupRuntime.js', 'js/appShell.js'],
            ...
            ['js/localGameStart.js', 'js/localGameStartRuntime.js', 'js/localGameInitializer.js', 'js/localGameRestartRuntime.js', 'js/main.js'],
            ['js/autoSkipPolicy.js', 'js/main.js'],
            ['js/pageActivationPolicy.js', 'js/pageActivationRuntime.js', 'js/main.js'],
            ['js/delayedHumanActionPolicy.js', 'js/pageActivationRuntime.js', 'js/main.js'],
            ['js/cpuSchedulerState.js', 'js/cpuTurnSchedulerRuntime.js', 'js/main.js'],
            ['js/cpuTurnStrategy.js', 'js/cpuPhaseHandlers.js', 'js/main.js'],
            ['js/localActionPolicy.js', 'js/mainHumanActionRuntime.js', 'js/main.js'],
            ['js/uiEventDelegation.js', 'js/mainUiEventRuntime.js', 'js/main.js'],
            ['js/uiRangeControl.js', 'js/mainUiEventRuntime.js', 'js/main.js'],
            ['js/uiRangeControl.js', 'js/storage.js'],
