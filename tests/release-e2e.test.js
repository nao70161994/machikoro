...
function loadUiModalRuntime() {
    ...
    context.global = context;
    vm.createContext(context);
    loadScripts(context, ['js/Card.js', 'js/Player.js', 'js/clientStorage.js', 'js/uiLogDisplay.js', 'js/uiCardOrder.js', 'js/uiPendingMenu.js', 'js/uiTutorial.js', 'js/uiDiceChoice.js', 'js/uiModalPolicy.js', 'js/uiWinner.js', 'js/uiTabView.js', 'js/ui.js']);
