...
function loadAppShellRuntime(profile = MOBILE_PROFILES[0]) {
    ...
    loadScripts(context, ['js/clientReporting.js', 'js/lifecycleNotify.js', 'js/uiWatchdog.js', 'js/appShell.js']);
...
function loadUiModalRuntime() {
    ...
    context.global = context;
    vm.createContext(context);
    loadScripts(context, ['js/Card.js', 'js/Player.js', 'js/uiLogDisplay.js', 'js/uiCardOrder.js', 'js/uiPendingMenu.js', 'js/ui.js']);
