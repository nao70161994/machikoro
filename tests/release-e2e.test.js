...
function loadAppShellRuntime(profile = MOBILE_PROFILES[0]) {
    ...
    loadScripts(context, ['js/actionContract.js', 'js/clientStorage.js', 'js/appShellStorage.js', 'js/clientReporting.js', 'js/lifecycleNotify.js', 'js/uiWatchdog.js', 'js/pwaShell.js', 'js/actionUiRegistry.js', 'js/appShell.js']);
