...
function loadAppShellRuntime(profile = MOBILE_PROFILES[0]) {
    ...
    loadScripts(context, ['js/actionContract.js', 'js/clientStorage.js', 'js/appShellStorage.js', 'js/clientReporting.js', 'js/clientReportingTransport.js', 'js/lifecycleNotify.js', 'js/lifecycleTransport.js', 'js/uiWatchdog.js', 'js/pwaShell.js', 'js/actionUiRegistry.js', 'js/uiTabView.js', 'js/appShell.js']);
