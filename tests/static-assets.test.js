...
runTest('static assets はschema negotiation flagを明示有効時だけ注入する', () => {
    ...
    assert.ok(!disabled.includes('MACHIKORO_ONLINE_RESTORE_QUEUE_STORE_WRITE_AUTHORITY_ENABLED'));
    ...
    assert.ok(!disabled.includes('MACHIKORO_ONLINE_GAME_ACTION_COMMIT_EFFECT_AUTHORITY_ENABLED'));
    assert.ok(!disabled.includes('MACHIKORO_ONLINE_ACTION_ACCEPTED_COMMIT_EFFECT_AUTHORITY_ENABLED'));
    assert.ok(!disabled.includes('MACHIKORO_ONLINE_SOCKET_CONNECT_PLAN_AUTHORITY_ENABLED'));
    assert.ok(!disabled.includes('MACHIKORO_ONLINE_SOCKET_CONNECT_EFFECT_AUTHORITY_ENABLED'));
    assert.ok(!disabled.includes('MACHIKORO_ONLINE_SOCKET_DISCONNECT_PLAN_AUTHORITY_ENABLED'));
    ...
    assert.ok(!disabled.includes('MACHIKORO_ONLINE_REJOIN_ACTION_LOG_PLAN_AUTHORITY_ENABLED'));
    assert.ok(!disabled.includes('MACHIKORO_ONLINE_LOCAL_HOST_RESTORE_OFFER_PLAN_AUTHORITY_ENABLED'));
    assert.ok(!disabled.includes('MACHIKORO_ONLINE_REJOIN_PERSISTENCE_PLAN_AUTHORITY_ENABLED'));
    ...
    assert.ok(!disabled.includes('MACHIKORO_ONLINE_RESTORE_ACTIVATION_PLAN_AUTHORITY_ENABLED'));
    assert.ok(!disabled.includes('MACHIKORO_ONLINE_RESTORE_ACTIVATION_EFFECT_AUTHORITY_ENABLED'));
