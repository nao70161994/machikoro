...
function loadMainRuntime(options = {}) {
    ...
    const clientCheckpointSource = fs.readFileSync(path.join(__dirname, '..', 'js/clientCheckpoint.js'), 'utf8');
    vm.runInContext(clientCheckpointSource, context, { filename: 'js/clientCheckpoint.js' });
    ...
    vm.runInContext(appShellObservationRuntimeSource, context, { filename: 'js/appShellObservationRuntime.js' });
    ...
    const appShellCrashRuntimeSource = fs.readFileSync(path.join(__dirname, '..', 'js/appShellCrashRuntime.js'), 'utf8');
...
runTest('CPU scheduler runtime stateはcontrollerだけが所有する', () => {
    ...
    const appShellRuntimeEffectsSource = fs.readFileSync(path.join(__dirname, '..', 'js/appShellRuntimeEffects.js'), 'utf8');
    const appShellObservationRuntimeSource = fs.readFileSync(path.join(__dirname, '..', 'js/appShellObservationRuntime.js'), 'utf8');
    for (const source of [mainSource, onlineSource, storageSource, appShellSource, appShellRuntimeEffectsSource, appShellObservationRuntimeSource]) {
    ...
    assert.ok(appShellSource.includes('runtimeEffects: appShellRuntimeEffects'));
    assert.ok(appShellObservationRuntimeSource.includes('runtimeEffects.schedulerSnapshot()'));
...
runTest('index.html のbrowser-global script orderは主要依存順を維持する', () => {
    ...
    assertBefore('js/gameDicePolicy.js', 'js/gameCardActivationPolicy.js');
    assertBefore('js/gameCardActivationPolicy.js', 'js/gameBuildPolicy.js');
    assertBefore('js/gameBuildPolicy.js', 'js/gameCoinTransaction.js');
    assertBefore('js/gameCoinTransaction.js', 'js/gamePendingResolutionPolicy.js');
    assertBefore('js/gamePendingResolutionPolicy.js', 'js/GameManager.js');
    ...
    assertBefore('js/onlineInboundActionRuntime.js', 'js/onlineLobbyStartRuntime.js');
    ...
    assertBefore('js/onlineRejoinActivationRuntime.js', 'js/online.js');
    assertBefore('js/onlineRejoinPersistence.js', 'js/onlineRejoinPreparationRuntime.js');
    assertBefore('js/onlineRejoinPreparationRuntime.js', 'js/online.js');
    ...
    assertBefore('js/uiModalClose.js', 'js/ui.js');
    ...
    assertBefore('js/uiGameStatusEffects.js', 'js/ui.js');
    assertBefore('js/uiTabView.js', 'js/uiTabEffects.js');
    assertBefore('js/uiTabEffects.js', 'js/ui.js');
    assertBefore('js/uiTabEffects.js', 'js/appShell.js');
    assertBefore('js/uiRenderRuntime.js', 'js/ui.js');
    ...
    assertBefore('js/onlineDomEffects.js', 'js/onlineSocketEffects.js');
    assertBefore('js/onlineSocketEffects.js', 'js/online.js');
