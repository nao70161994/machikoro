...
const CARD_EFFECT_METADATA = Object.freeze({
    ...
    [CARD_EFFECTS.FURNITURE]:     { timing: "income", targetScope: "self",      cpuKind: "comboIncome", incomeHandler: "furniture" },
    [CARD_EFFECTS.MARKET]:        { timing: "income", targetScope: "self",      cpuKind: "comboIncome", incomeHandler: "market" },
    [CARD_EFFECTS.FLOWER]:        { timing: "income", targetScope: "self",      cpuKind: "comboIncome", incomeHandler: "flower" },
    [CARD_EFFECTS.FOODWAREHOUSE]: { timing: "income", targetScope: "self",      cpuKind: "comboIncome", incomeHandler: "foodwarehouse" },
    [CARD_EFFECTS.FEWLANDMARK]:   { timing: "income", targetScope: "self",      cpuKind: "conditionalIncome", incomeHandler: "fewlandmark" },
    [CARD_EFFECTS.WINERY]:        { timing: "income", targetScope: "self",      cpuKind: "comboIncome", incomeHandler: "winery", sideEffect: "dormantSelf" },
    [CARD_EFFECTS.MOVER]:         { timing: "pending", targetScope: "opponent",  cpuKind: "interactive" },
    [CARD_EFFECTS.DRINKFACTORY]:  { timing: "income", targetScope: "self",      cpuKind: "comboIncome", incomeHandler: "drinkfactory" },
    ...
    [CARD_EFFECTS.CORNFIELD]:     { timing: "income", targetScope: "self",      cpuKind: "conditionalIncome", incomeHandler: "cornfield" },
...
function getCardActivationProfile(card) {
    ...
    return Object.freeze({
        ...
        incomeHandler: metadata.incomeHandler || null,
...
const CARD_DEFS = Object.freeze([
    ...
    Object.freeze({ id: "general_store", name: "雑貨屋", cost: 0, diceNums: Object.freeze([2]), income: 2, color: "green", category: "商店", effect: "fewlandmark" }),
    ...
    Object.freeze({ id: "loan_office", name: "貸金業", cost: 0, diceNums: Object.freeze([5,6]), income: 0, color: "green", category: "特殊", effect: "loan" }),
    Object.freeze({ id: "winery", name: "ワイナリー", cost: 3, diceNums: Object.freeze([9]), income: 6, color: "green", category: "工業", effect: "winery" }),
    Object.freeze({ id: "moving_company", name: "引越し屋", cost: 2, diceNums: Object.freeze([9,10]), income: 4, color: "green", category: "特殊", effect: "mover" }),
...
const CARD_EFFECT_DESCRIPTIONS = Object.freeze({
    ...
    [CARD_EFFECTS.FOODWAREHOUSE]:(i) => `カップマーク施設1軒につき+${i}コイン`,
    ...
    [CARD_EFFECTS.FEWLANDMARK]:  (i) => `ランドマーク0-1軒なら+${i}コイン`,
