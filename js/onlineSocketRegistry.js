...
const OnlineSocketRegistry = (() => {
    const keys = Object.freeze({
        ...
        ONLINE_REMATCH_STATUS: 'onlineRematchStatus',
        ONLINE_REMATCH_IDENTITY: 'onlineRematchIdentity',
    ...
    const staticEventNames = Object.freeze({
        ...
        [keys.ONLINE_REMATCH_STATUS]: 'onlineRematchStatus',
        [keys.ONLINE_REMATCH_IDENTITY]: 'onlineRematchIdentity',
