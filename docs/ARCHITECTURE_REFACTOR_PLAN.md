...
| `js/uiBuildMenu.js` | Pure build gate/action-state and Undo visibility/enabled projection, data-to-HTML helpers, safe button attributes, available-card display. |
