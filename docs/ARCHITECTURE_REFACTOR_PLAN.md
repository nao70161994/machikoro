...
- `js/localPlayerSettings.js` owns local player-setting normalization, CPU/RL labels, speed text, snapshots, escaping, and exact settings HTML. `main.js` retains mutable state, DOM assignment, storage calls, RL preload, and game-start effects.
