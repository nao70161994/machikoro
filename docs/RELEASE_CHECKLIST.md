...
- Run the URL metadata / public-page link hint checks, public OGP/PWA icon reachability checks, local OGP/PWA icon dimension check, and static explanation page negative checks in `docs/ADSENSE_SETUP.md` before submitting and when rechecking public pages during review; they should finish with `Public page URL metadata and public-page link hint checks passed`, `Local OGP/PWA icon dimension checks passed`, and `Static explanation page negative checks passed`.
