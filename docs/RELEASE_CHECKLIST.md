...
- Run the static explanation page negative checks in `docs/ADSENSE_SETUP.md` before submitting; they should finish with `Static explanation page negative checks passed`.
