...
- `privacy.html` and `rules.html` remain static explanation pages: no page script, form, button, app `id`/`data-*` attribute, `data-ui-action`, ad placeholder, or AdSense loader is added to either public page.
