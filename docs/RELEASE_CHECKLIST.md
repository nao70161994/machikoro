...
- Public pages include OGP/Twitter metadata with `/icons/icon-512.png` as the preview image and image alt metadata; the title page metadata mentions no-registration play.
