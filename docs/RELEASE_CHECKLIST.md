...
- `privacy.html` and `rules.html` remain static explanation pages: no page script, form, button, inline event handler, app `id`/`data-*` attribute, `data-ui-action`, ad placeholder, or AdSense loader is added to either public page.
