...
- `privacy.html` and `rules.html` are reachable from the title screen and cached by the PWA shell; `privacy.html` also mentions contact guidance and the last updated date.
