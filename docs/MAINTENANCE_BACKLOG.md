...
| CPU lookahead simulation | Deterministic playout RNG, loop, and simulation-only phase steps lived beside game cloning and live CPU execution. | `js/cpuSimulation.js` owns the seeded LCG and injected lookahead loop/step; CPU wrappers retain cloning and live execution ownership. |
