...
- Confirm `rules.html` describes how to start a local or online game, save/resume behavior, plus the win condition, turn flow, card colors, activation order, and landmarks.
