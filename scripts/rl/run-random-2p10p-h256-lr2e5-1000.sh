...
exec sh scripts/rl/run-baseline.sh \
    --run-label random-2p10p-both-h256-lr2e5-1000 \
    ...
    --js-eval-games 2 \
    --js-eval-lineups "rl,weak,normal,strong;rl,normal,normal,strong;rl,strong,strong,strong;rl,weak,normal,strong,expert" \
    --summary-weights "rl+weak+normal+strong=2,rl+normal+normal+strong=3,rl+strong+strong+strong=4,rl+weak+normal+strong+expert=4" \
