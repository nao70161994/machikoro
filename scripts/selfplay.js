...
function loadRuntime(options = {}) {
    ...
    const runtimeFiles = ['js/Card.js', 'js/Player.js', 'js/GameManager.js', 'js/cpuTuning.js', 'js/cpuProfile.js', 'js/cpuDiagnostics.js', 'js/cpuEvaluationCache.js', 'js/cpuEvaluation.js', 'js/cpuLegalMoves.js', 'js/cpuBuildExecution.js', 'js/cpuSimulation.js', 'js/cpuPendingResolution.js', 'js/CPU.js'];
