...
function parseArgs(argv) {
    ...
    return { modelPath, opponent, seed, maxSteps, rlSeat, rolls };
}
...
function exportJsMatchTrace(options = {}) {
    ...
    const traceEntries = [];
    const players = buildPlayers(options.opponent || 'strong', options.rlSeat || 'first');
    ...
    return {
        source: 'js',
        opponent: options.opponent || 'strong',
        seed: options.seed || 1,
        maxSteps: options.maxSteps || 5000,
