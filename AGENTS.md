...
- RL 候補モデルは `models/rl_model/registry.json` に記録します。モデル本体・`runs/`・metrics は生成物扱いですが、実ゲームで使う配布用 browser JSON は `models/rl_model/portfolio/` に置きます。2026-04時点では 3〜4人用に `self-only-4p-h256-lr1e5-5000-seed102` を採用しています。
